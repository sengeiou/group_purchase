...
import com.mds.group.purchase.shop.dao.WxmpMapper;
...
public class WxmpServiceImpl extends AbstractService<Wxmp> implements WxmpService {
    @Resource
    private WxmpMapper tWxmpMapper;
